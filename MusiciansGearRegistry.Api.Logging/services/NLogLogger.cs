...
namespace MusiciansGearRegistry.Api.Logging.Services;

public class NLogLogger : NLog.Logger, ILoggingService
{
    ...
    public ILoggingService GetLoggingService(string name)
    {
        ...
        ILoggingService logger = (ILoggingService)LogManager.GetLogger(name, typeof(NLogLogger));
        return logger;
    }
